;(function($) {
    ...
    var AJS = (function() {
         ...
         * --
         * @param  {string}   name      The name of class we need to register. 
         *                              Must start with: 
         *                              Controller, Library or Model
         *                              Example: Controller.Events.Index
         * @param  {function} exe_class Class we wanna register
         * @param  {boolean}  autorun   Should the class be auto-initialized, 
        ...
        _public.register = function(name, exe_class, autorun) {
            ...
            // Check if we're having Controller || Library || Model
